...
export const toolContentAr: Record<string, ToolContent> = {
  ...
  "form-filler": {
    ...
    "description": "\n      <p>تسمح لك أداة تعبئة النماذج بإكمال نماذج PDF التفاعلية مباشرة في متصفحك. املأ حقول النص، وحدد المربعات، واختر الخيارات دون طباعة المستند.</p>\n      <p>تدعم الأداة حقول AcroForm القياسية. يمكن تنزيل بياناتك المعبأة ويمكن \"تسطيح\" النموذج لمنع المزيد من التعديل. نماذج XFA غير مدعومة حالياً.</p>\n      <p>تتم جميع عمليات المعالجة محلياً في متصفحك، مما يضمن بقاء بيانات النموذج خاصة.</p>\n    ",
    "howToUse": [
      {
        "step": 1,
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "ليس حالياً. تدعم الأداة نماذج AcroForm القياسية وتكتشف الملفات التي تعتمد على XFA فقط."
      }
    ]
  },
  "form-creator": {
