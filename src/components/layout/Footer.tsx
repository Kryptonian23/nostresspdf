        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 md:col-span-1 flex flex-col gap-6">
            ...
            >
              <Image
                ...
                width={32}
                height={32}
                className="h-8 w-8 rounded-lg shadow-md transition-transform group-hover:scale-105"
              />
            ...
            <ul className="flex flex-col gap-4">
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <span className="text-xs text-[hsl(var(--color-muted-foreground))]">Documents stay on your device</span>
                </div>
              </li>
            </ul>
          </div>
          ...
          <div className="flex flex-col justify-start">
            ...
            >
              ...
              <div>
                <div className="text-sm font-bold text-[hsl(var(--color-foreground))]">No file transfer</div>
                <div className="text-xs text-[hsl(var(--color-muted-foreground))]">Processing runs locally</div>
              </div>
            </div>
          </div>
        </div>
